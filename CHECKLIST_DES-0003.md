# Checklist V3 — desafio de votação
...
✅ Implementado com k6 2.2.0 e ambiente Docker isolado e reproduzível.

- Smoke: 10 votos, zero falhas, p95 de 23,65 ms e p99 de 29,69 ms;
- Load: 100 votos/s por 2 minutos, 12.001 votos, zero falhas ou descartes, p95 de 6,97 ms e p99 de 10,40 ms;
- Volume: 200.000 votos com 100 VUs, zero falhas, ~3.203,85 votos/s, p95 de 55,51 ms e p99 de 94,57 ms;
- todos os votos foram confirmados pela consulta de resultado ao final de cada cenário;
- thresholds exigem zero erro, zero descarte, contagem correta, p95 abaixo de 500 ms e p99 abaixo de 1 segundo;
- cada execução gera dashboard HTML, resumo JSON, log e metadados sob `performance-results/`;
- stress, spike e soak foram dispensados neste ciclo porque todos os perfis ficaram com ampla margem; eles dependem de uma meta específica de limite, rajada ou duração.
